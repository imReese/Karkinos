...
机器可读表头；不要在表头下添加中文说明行，否则会被当作业务记录校验。
解析器按列名而不是列序取值，但建议沿用模板顺序便于人工核对。
...
```csv
event_id,event_type,occurred_at,settled_at,symbol,instrument_name,asset_class,currency,quantity,price,gross_amount,fee,tax,net_amount,cash_balance,position_quantity,cost_basis,transfer_fee,cost_basis_method,note
synthetic-buy-001,trade_buy,2026-01-05T09:35:00+08:00,2026-01-06,SYN001,合成样例股票A,stock,CNY,100,10.23,1023.00,5.00,0.00,-1028.00,8972.00,100,10.28,0.00,broker_remaining_cost,synthetic buy row
synthetic-sell-001,trade_sell,2026-01-06T10:10:00+08:00,2026-01-07,SYN001,合成样例股票A,stock,CNY,20,10.50,210.00,5.00,0.21,204.79,9176.79,80,10.28,0.00,broker_remaining_cost,synthetic sell row
...
synthetic-position-001,position_snapshot,2026-01-15T15:10:00+08:00,2026-01-15,SYN001,合成样例股票A,stock,CNY,0,10.40,0.00,0.00,0.00,0.00,9387.29,80,10.28,,broker_remaining_cost,synthetic position snapshot

...
does not start a broker client, retain credentials, submit/cancel orders, or
write OMS/ledger. Legacy broker-named export types do not automatically create
adapters; a third-party adapter needs dependency, credential, capability,
recovery, release, and rollback review plus explicit authorization.

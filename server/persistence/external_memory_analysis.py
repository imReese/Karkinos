"""SQLite repository for external memory-analysis requests and call receipts."""
...
from server.contracts.external_memory_analysis import (
    ...
    ExternalMemoryAnalysisPersistenceInputs,
...
EXTERNAL_MEMORY_ANALYSIS_SCHEMA = """
...
class ExternalMemoryAnalysisStore:
    ...
    def init(self) -> None:
        with self._connection() as conn:
            conn.executescript(EXTERNAL_MEMORY_ANALYSIS_SCHEMA)
...
def record_from_row(row: sqlite3.Row) -> ExternalMemoryAnalysisRecord:
...
def model_call_from_row(row: sqlite3.Row) -> ExternalModelCallRecord:

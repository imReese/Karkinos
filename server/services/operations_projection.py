"""Canonical persisted-fact Operations projection."""
...
from server.services.controlled_per_order_pilot_readiness import (
    build_controlled_per_order_pilot_readiness as _compose_pilot_readiness,
)
...
from server.services.decision_application import (
    decision_portfolio_context as _decision_portfolio_context,
)
from server.services.decision_application import (
    today_decision_payload as _today_decision_payload,
)
from server.services.decision_application import (
    trading_plan_positions as _trading_plan_positions,
)
...
def _build_controlled_per_order_pilot_readiness(
    ...
    *,
    ...
    return _compose_pilot_readiness(
...
def build_controlled_per_order_pilot_readiness(
    ...
    *,
    ...
    """Build the canonical controlled per-order pilot admission projection."""
    return _build_controlled_per_order_pilot_readiness(
        state,
        broker_adapter_readiness=broker_adapter_readiness,
    )

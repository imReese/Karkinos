...
MARKET_UNIVERSE_POLICY_VERSION = "karkinos.market_universe_policy.v1"
MARKET_UNIVERSE_TRUTH_SCHEMA_VERSION = "karkinos.market_universe_truth.v1"
RESEARCH_PANEL_SCHEMA_VERSION = "karkinos.research_panel_snapshot.v1"
...
def build_market_universe_truth(
    *,
    ...
    preliminary = preliminary_research_panel_symbols(verified, policy=active_policy)
    eligible: list[dict[str, Any]] = []
    excluded_reason_counts: dict[str, int] = {}
    for symbol_text in preliminary:
        assessment = _assess_panel_member(
    ...
    truth_core = {
        ...
        "research_backfill_pool_count": len(preliminary),
...
def _assess_panel_member(
    *,
    ...
    if len(window) < policy.minimum_history_rows:

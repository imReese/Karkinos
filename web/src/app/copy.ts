...
export const copy = {
  en: {
    ...
    backtest: {
      page: {
        ...
        assets: 'Assets',
        assetsPlaceholder: '600519 stock\n018125 fund',
    ...
    settings: {
      ...
      enableDemoQuotes: 'Enable Demo quotes',
      enablingDemoQuotes: 'Enabling Demo quotes',
      demoQuotesEnabled: 'Demo quotes enabled',
      demoQuotesDetail:
  ...
  zh: {
    ...
    settings: {
      ...
      enableDemoQuotes: '启用 Demo 行情',
      enablingDemoQuotes: '启用中',
      demoQuotesEnabled: 'Demo 行情已启用',
      demoQuotesDetail:
        'Demo 行情使用本地确定性价格，仅用于开发验证，不是市场数据。',
      providerTimeoutNotice:
        '当前行情源请求超时。可切换到 Demo 行情用于本地开发，或检查供应商配置。',

  ...
  en: {
    ...
    overview: {
      ...
      dashboard: {
        ...
        positionsDetail:
          'Live price, cost basis, market value, and floating PnL from backend projections.',
        tradeBuy: 'Buy',
        tradeSell: 'Sell',
        cashDeposit: 'Deposit',
      ...
      equityCurve: {
        ...
        realtimeUnrealizedPnl: 'Real-time Unrealized P/L',
      },
      livePulse: {
    ...
    portfolio: {
      ...
      liveBoard: {
        ...
        empty:
          'No active holdings yet. Record the first trade to start tracking live returns.',
    ...
    riskPage: {
      ...
      largestPositionDetail:
        'Single-name concentration of the biggest live holding.',
      ...
      noConcentration:
        'No live positions available for concentration analysis.',
    },
    trading: {
      killSwitch: {
  ...
  zh: {
    ...
    overview: {
      ...
      dashboard: {
        ...
        ledgerEmpty: '还没有账本流水。',
        positionsPanel: '当前持仓',
        positionsDetail: '来自后端投影的实时价格、成本、市值与浮动盈亏。',
        tradeBuy: '买入',
        tradeSell: '卖出',
        cashDeposit: '入金',
        cashWithdrawal: '出金',
    ...
    explainability: {
      ...
      equityBridgeDetails: {
        ...
        cash: '可用于再平衡、防守或下一笔交易的即时缓冲。',
        market_value: '当前持仓按最新价格估算的总市值。',
    ...
    activity: {
      ...
      title: '账本活动台',
      subtitle:
        '手工录入交易、分红、现金流和调整，并即时回刷资产、收益和持仓。',
      loading: '正在加载账本流水。',
      error: '账本流水加载失败。',
      tradeSaved: '交易已保存',
      tradeFailed: '交易保存失败',

...
export const copy = {
  en: {
    ...
    explainability: {
      ...
      historicalSnapshotsRequired: 'Historical snapshots required',
      returnCalendarEmptyDetail:
        'Daily, monthly, and annual calendars need at least two dated equity snapshots. Current holdings are shown here without fabricating historical attribution.',
      marketValue: 'Market value',
      unrealizedPnl: 'Unrealized PnL',
  ...
  zh: {
    ...
    explainability: {
      ...
      historicalSnapshotsRequired: '需要历史权益快照',
      returnCalendarEmptyDetail:
        '日级、月级与年度收益日历至少需要两个带日期的权益快照。这里先展示当前持仓收益，不伪造历史归因。',
      marketValue: '持仓市值',
      unrealizedPnl: '浮动盈亏',
      timelineRange: '日期区间',

...
export const copy = {
  en: {
    ...
    aiResearchPage: {
      kicker: 'AI research',
      title: 'Cited research review',
      subtitle:
        'Capture canonical persisted context, inspect cited artifacts, and record a human conclusion without granting execution authority.',
      context:
        'Human-started · persisted evidence only · non-authoritative output',
      openStrategyLab: 'Open Strategy Lab',
      activation: 'Activation',
      manualOnly: 'Manual only',
      noImplicitModel: 'No implicit model or provider call',
      backtestContext: 'Backtest context',
      strategyContext: 'Strategy context',
      available: 'Available',
      unavailable: 'Unavailable',
      savedBacktest: (id: number) => `Canonical report #${id}`,
      backtestLoadFailed: 'Saved reports could not be read',
      noSavedBacktest: 'No canonical report is available',
      persistedAssignment: 'Exact persisted account assignment',
      strategyLoadFailed: 'Strategy assignment could not be read',
      noStrategyAssignment: 'No persisted strategy assignment',
      authority: 'Authority',
      none: 'None',
      noBrokerOrCapital: 'No broker, order, or capital authority',
    },
    operationsPage: {
      kicker: 'Operations',
  ...
  zh: {
    ...
    aiResearchPage: {
      ...
      title: '引用证据研究复核',
      subtitle:
        '捕获 canonical 持久化上下文，复核带引用的研究产物，并记录不授予执行权限的人工结论。',
      context: '人工启动 · 仅持久化证据 · 非权威输出',
      openStrategyLab: '打开策略实验',
      activation: '启动方式',
      manualOnly: '仅人工启动',
      noImplicitModel: '不隐式调用模型或 provider',
      backtestContext: '回测上下文',
      strategyContext: '策略上下文',
      available: '可用',
      unavailable: '不可用',
      savedBacktest: (id: number) => `Canonical 报告 #${id}`,
      backtestLoadFailed: '无法读取已保存报告',
      noSavedBacktest: '暂无 canonical 回测报告',
      persistedAssignment: '精确持久化账户策略绑定',
      strategyLoadFailed: '无法读取策略绑定',
      noStrategyAssignment: '暂无持久化策略绑定',
      authority: '权限',
      none: '无',
      noBrokerOrCapital: '无券商、订单或资本权限',
    },
    operationsPage: {
      kicker: '运营',
      title: '运行证据中心',

...
const CSS_NUMERIC_TYPOGRAPHY_EXCEPTIONS = new Set([
  ...
  '.app-public-hero-title|font-size|clamp(2.4rem, 5.5vw, 3.8rem)',
  '.app-public-hero-title|letter-spacing|-0.047em',
  '.app-public-hero-title|line-height|1.04',
  '.app-public-hero-title|word-spacing|0.07em',
  ':lang(zh) .app-public-hero-title|letter-spacing|-0.038em',
  ':lang(zh) .app-public-hero-title|line-height|1.12',
  '.app-public-hero-body|font-size|clamp(0.96rem, 1.25vw, 1.1rem)',
  '.app-public-hero-body|line-height|1.68',
  '.app-public-evidence-heading h2|font-size|clamp(1.45rem, 2.3vw, 1.95rem)',
  '.app-public-evidence-heading h2|letter-spacing|-0.035em',
  '.app-public-evidence-heading h2|line-height|1.15',
  '.app-public-preview-metrics dt, .app-public-priority-preview dt|letter-spacing|0.06em',
  '.app-public-priority-preview h3|font-size|clamp(1.1rem, 1.6vw, 1.35rem)',
  '.app-public-priority-preview h3|letter-spacing|-0.025em',
  '.app-public-priority-preview h3|line-height|1.2',

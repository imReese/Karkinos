...
export function readinessContractIsSafe(
  value: unknown,
...
export function gateLabel(value: string, locale: Locale) {
...
export function actionLabel(value: string, locale: Locale) {
  const labels: Record<string, { en: string; zh: string }> = {
...
export function blockerLabel(value: string, locale: Locale) {
...
export function resolutionLabel(value: string, locale: Locale) {
  return (

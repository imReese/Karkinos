...
function DailyCandidateFinancialPreflightPanel({
  ...
  const evidenceLabels: Record<string, { zh: string; en: string }> = {
  ...
  const completionLabels: Record<string, { zh: string; en: string }> = {
  ...
  const gateReviewPaths: Record<string, string> = {
